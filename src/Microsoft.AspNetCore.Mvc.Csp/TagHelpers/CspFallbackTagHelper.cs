...
{
    /// <summary>
    /// A tag helper to automatically hash any fallback scripts generated by the ScriptTagHelper and LinkTagHelper.
    /// This allows fallbacks to be used without having to specify 'unsafe-inline' in the content security policy.
    /// </summary>
    ...
    public class CspFallBackTagHelper : TagHelper
    {
        ...
        // This tag helper must run after the ScriptTagHelper or LinkTagHelper
        // as it generates hashes based on the fallback script tags markup.
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            // Check if the ScriptTagHelper or LinkTagHelper have actually output the fallback <script> tags.
